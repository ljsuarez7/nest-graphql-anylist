...
export class ListsService {
  ...
  async create(createListInput: CreateListInput, user: User): Promise<List> {
    const newList = this.listsRepository.create({...createListInput, user}); //desestructuramos y añadimos el usuario
  ...
  async remove(id: string, user: User): Promise<List> {
    ...
    return {...list, id}; //Esto lo tenemos que hacer porque se pierde el id al eliminarlo y necesitamos mandarselo al resolver
  }
